        ...
        /*
         ...
         <insert id="insertWithArray">
            ...
            values(
                #{timestamp},
                #{id},
                #{arr, jdbcType=INTEGER, typeHandler=com.ldzl.txjinterface.handler.ArrayTypeHandler},
                #{arrFl, jdbcType=FLOAT, typeHandler=com.ldzl.txjinterface.handler.ArrayTypeHandler}
            );
         </insert>
         当 MyBatis 解析到 #{arr, jdbcType=INTEGER, typeHandler=com.ldzl.txjinterface.handler.ArrayTypeHandler} 这句代码，
